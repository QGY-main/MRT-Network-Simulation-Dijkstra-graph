...
| **Utilization factor** | Crowding at a station — passenger flow relative to service capacity | **Lower is better.** Values approaching or exceeding the system's practical service rate indicate severe crowding |
